type MyIconProps = {
  name: "checkIcon" | "circleIcon" | "pencilIcon" | "deleteIcon" | "gripIcon" | "darkIcon" |"lightIcon";
  className?: string;
  width?: string;
  height?: string;
  color?: string;
