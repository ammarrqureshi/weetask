...
export const TaskList = () => {
  ...
  return (
    <section className="box-border overflow-hidden w-full relative flex flex-col gap-4 justify-center items-center flex-wrap pt-4 pb-8 mt-4 border-t border-slate-800">
      ...
      <Accordion className=" w-full opacity-40 text-xs" title="Completed Tasks">
        <div
          id="completed-tasks"
          className="  flex flex-col gap-4 justify-center w-full items-center flex-wrap border-t border-slate-800 bg-inherit w-full pt-4 opacity-30"
        >
          {tasks.map((task, index) => {
